...
Secrets are passed via environment variables. `POSTGRES_PASSWORD` is required and has no default — you must set it before running `docker compose up`:

| Variable | Description | Default |
|----------|-------------|---------|
| `POSTGRES_PASSWORD` | PostgreSQL password | **Required** — no default provided |
