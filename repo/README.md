...
Secrets are passed via environment variables. Development defaults allow `docker compose up` to work immediately. Override for production:

| Variable | Description | Default |
|----------|-------------|---------|
| `POSTGRES_PASSWORD` | PostgreSQL password | Development default provided — **override in production** |
| `APP_KEY` | Backend encryption key | Auto-generated by entrypoint |
| `FRONTEND_APP_KEY` | Frontend encryption key | Auto-generated by entrypoint |
