    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-600">Browse community campaigns and venue programs happening near you.</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-600">Reserve seats, support campaigns, and receive digital vouchers.</p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-600">Attend events, leave reviews, and build your community reputation.</p>
            </div>
        </div>
    </div>
</x-layouts.app>
