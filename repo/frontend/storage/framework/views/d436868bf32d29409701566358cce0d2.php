    ...
    <div class="bg-indigo-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            ...
            <div class="mt-10 flex justify-center space-x-4">
                <a href="<?php echo e(route('campaigns.list')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-50 transition shadow-sm">
                    Browse Campaigns
                </a>
                <a href="<?php echo e(route('programs.list')); ?>" class="inline-flex items-center px-6 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-indigo-600 transition">
                    View Programs
                </a>
            </div>
        </div>
